...
@Component({
  selector: 'app-mad-incidencia',
  templateUrl: './mad-incidencia.component.html',
  styleUrl: './mad-incidencia.component.scss',
  standalone: true,
...
export class MadIncidenciaComponent implements AfterViewInit {
